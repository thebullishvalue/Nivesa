...
def get_positions_dataframe():
    ...
    for (bid, acct), grp in txns.groupby(['bond_id', 'account']):
        ...
        # YTC = yield locked in at purchase (anchored at the weighted buy date).
        ytc = calc_yield_to_cost(fv_pu, cost_pu, si['coupon_rate'], si['maturity_date'], si['frequency'], day_count, as_of=wavg_buy_date)
        ...
        # not at the seasoning-invariant purchase yield.
